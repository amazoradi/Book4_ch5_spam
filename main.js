...
// create an empty array to push each contacts array of email addresses into
let allEmailsArr = []

customers.forEach(customers => {
  allEmailsArr.push(customers.contacts.email) 
}) 
// result is a series of arrays (one for each contact) consisting of arrays of emails


// making one array of all emails (not in indiviual arrays)
emailArr = allEmailsArr.reduce((a,b) => a.concat(b))
